...
from agents import FundamentalAgent, RiskAgent, ValuationAgent, TrendCommentaryAgent, GuidanceAgent
from renderer import EquityBriefRenderer
...
# from data_layer import RobustDataProcessor, CompanyFinancialProfile   # ← old: edgartools single-filing
from data_layer import CompanyFinancialProfile
from facts_processor import FactsDataProcessor, set_identity as _facts_set_identity
from fr_y9c import FRY9CFetcher, _FALLBACK_RSSD_MAP as RSSD_MAP
from ownership_loader import OwnershipLoader
from insider_transactions import InsiderTransactionLoader
from short_interest_loader import ShortInterestLoader
from peer_comparator import PeerComparisonLoader
from company_overview import CompanyOverviewLoader
from analyst_targets import AnalystTargetsLoader
from price_context import PriceContextLoader
from estimate_revisions import EstimateRevisionsLoader
from momentum import MomentumLoader
from filing_cache import FilingCache
from transcript_loader import TranscriptLoader
from edgar_transcript import EdgarTranscriptLoader
from fool_transcript_db import maybe_update as _db_maybe_update
from guidance_tracker import GuidanceTracker
from config import FRED_API_KEY
from fred_client import FredClient
from debt_note_fetcher import fetch_debt_note
from xbrl_debt_fetcher import set_identity as _xbrl_set_identity
...
class EquityAnalystOrchestrator:
    ...
    def __init__(self,
        ...
        # Resolve paths relative to the project root (directory of this script)
