...
from universe.ticker_universe import UNIVERSE, TickerEntry, get_by_tier, get_by_sector
...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "phase2_output")
